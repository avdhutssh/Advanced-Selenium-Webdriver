...
public class JavaScriptAlertsPage extends BasePageObject {
	...
	private By clickForJSAlertButtonLocator = By.xpath("//*[normalize-space(text())='Click for JS Alert']");
	private By clickForJSConfirmButtonLocator = By.xpath("//*[normalize-space(text())='Click for JS Confirm']");
	private By clickForJSPromptButtonLocator = By.xpath("//*[normalize-space(text())='Click for JS Prompt']");
